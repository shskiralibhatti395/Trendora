...
export const ProductDetailPage = ({
  ...
  const { addToCart, toggleWishlist, isInWishlist, user, showToast } = useStore();
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      await productService.addReview(productId, ratingInput, commentInput);
      showToast("Thank you! Your review was posted successfully.", "success");
      setCommentInput("");
      setRatingInput(5);
      fetchProductDetail();
    } catch (err) {
